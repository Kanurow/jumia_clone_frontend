    ...
    const fetchData = async () => {
      try {
        ...
        const productsResponse = await axios.get(
          'https://jumia-clone-bra6.onrender.com/api/products/computing',
          {
            headers: {
              'Content-Type': 'application/json',
              Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
        ...
        setComputing(productsResponse.data);
      } catch (error) {
...
export default ComputingCarousel;
